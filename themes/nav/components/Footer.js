...
const Footer = ({ siteInfo }) => {
  ...
  return (
        ...
        >
            ...
            <div className='text-xs font-serif py-1 hidden'>Powered By <a href='https://ruilanxi.com' className='underline text-gray-500 dark:text-gray-300'>Ruilanxi.com {siteConfig('VERSION')}</a></div>
